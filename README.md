...
another document, or snapshot changes `render` does not reflect — is a `stale-render-record`. All of them fail, a renderer change included, because `check` reads the
